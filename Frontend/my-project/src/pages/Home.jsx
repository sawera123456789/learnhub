...
const API_URL = "https://learnhub1-ten.vercel.app//api/courses";
    ...
    return (
        <div>
            <section className="hero">
                ...
                <p>
                    LearnHub is a student learning platform where you can explore real courses,
                    register, and start building your future - one skill at a time.
                </p>
            ...
            <section className="section container">
              <div className="section-title">
                ...
                <div className="why-us-grid">
                 ...
                 <p>Learn from instructors who build real software every day.</p>
                </div>
                <div className="why-us-card">
                <div className="icon"></div>
                <h3>Hands-on practice</h3>
                <p>Every course includes practical tasks and real project work.</p>
                </div>
                <div className="why-us-card">
                    <div className="icon"></div>
                    <h3>Career Growth</h3>
